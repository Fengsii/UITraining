...
namespace UITraining.Migrations
{
    ...
    [Migration("20250411120156_addanytableindatabase")]
    partial class addanytableindatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UITraining.Models.DB.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 11, 12, 1, 55, 335, DateTimeKind.Utc).AddTicks(1234),
                            Email = "admin@example.com",
                            Name = "Administrator",
                            PasswordHash = "BFYB0hcFt1cE+pO3FIHcsBc4k8vUfsZte5Fq/uBp870XH11C47dYhSDL16/JmFXMv6/I1QrjirFwqp+rw2Aexw==",
                            Role = "Admin",
                            Salt = "EgIefaRswrly4i+gydMFNg==",
                            UserStatus = 0,
                            Username = "admin"
                        });
                });
